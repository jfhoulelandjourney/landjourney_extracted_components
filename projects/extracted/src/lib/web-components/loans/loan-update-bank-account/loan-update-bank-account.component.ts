...
@Component({
  selector: 'lj-loan-update-bank-account',
  imports: [
    FormsModule,
    MatExpansionModule,
    MatIconModule,
  ...
  templateUrl: './loan-update-bank-account.component.html',
  styleUrl: './loan-update-bank-account.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LoanUpdateBankAccountComponent {
  ...
  currentBankName = 'Bank of America';
  currentAccountMask = '•••• •••• ••1234';
  currentRoutingMask = '••• •••• 678';
