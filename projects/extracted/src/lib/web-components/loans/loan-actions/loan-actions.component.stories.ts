...
import { LoanActionsComponent } from './loan-actions.component';

const meta: Meta<LoanActionsComponent> = {
  title: 'Web Components / Loans / Loan Actions',
  component: LoanActionsComponent,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
...
export default meta;
type Story = StoryObj<LoanActionsComponent>;
