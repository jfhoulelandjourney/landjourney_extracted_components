...
@Component({
  ...
  selector: 'lj-loan-request-payoff',
  templateUrl: './loan-request-payoff.component.html',
  styleUrls: ['./loan-request-payoff.component.scss'],
  imports: [
    MatIconModule,
    LoanHeaderComponent,
    ActivateDirective,
...
export class LoanRequestPayoffComponent {
  ...
  confirmPayoff() {
    this.servicingService
      .sendPayOffRequest(
        ...
        this.loan()?.principalBalanceCents ?? 0,
