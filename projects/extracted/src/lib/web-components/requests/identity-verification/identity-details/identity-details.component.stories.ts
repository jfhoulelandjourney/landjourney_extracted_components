...
const meta: Meta<IdentityDetailsComponent> = {
  title: 'Web Components / Requests / Identity Verification / Identity Details',
...
export default meta;
type Story = StoryObj<IdentityDetailsComponent>;
