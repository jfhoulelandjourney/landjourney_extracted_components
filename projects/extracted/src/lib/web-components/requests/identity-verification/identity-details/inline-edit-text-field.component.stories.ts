...
const meta: Meta<InlineEditTextFieldComponent> = {
  title: 'Web Components / Requests / Identity Verification / Identity Details / Inline Edit Text Field',
  component: InlineEditTextFieldComponent,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
...
export default meta;
type Story = StoryObj<InlineEditTextFieldComponent>;
