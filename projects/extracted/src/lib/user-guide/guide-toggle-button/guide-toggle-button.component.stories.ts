...
import { GuideToggleButtonComponent } from './guide-toggle-button.component';

const meta: Meta<GuideToggleButtonComponent> = {
  title: 'User Guide / Guide Toggle Button',
  component: GuideToggleButtonComponent,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
...
export default meta;
type Story = StoryObj<GuideToggleButtonComponent>;
