...
const meta: Meta<BorrowerInformationComponent> = {
  title: 'Dynamic Forms / Dynamic Form / Field / Borrowers Field / Borrower Information',
...
export default meta;
type Story = StoryObj<BorrowerInformationComponent>;
