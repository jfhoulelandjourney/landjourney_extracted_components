...
const meta: Meta<FieldConfigurationComponent> = {
  title: 'Dynamic Forms / Dynamic Form Editor / Configuration / Field Configuration',
...
export default meta;
type Story = StoryObj<FieldConfigurationComponent>;
