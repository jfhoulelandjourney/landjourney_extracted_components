...
const meta: Meta<ConditionalLogicComponent> = {
  title: 'Dynamic Forms / Dynamic Form Editor / Configuration / Conditional Logic',
...
export default meta;
type Story = StoryObj<ConditionalLogicComponent>;
